...
invariant
	...
	consistent_cross_board_outputs: cross_board.out ~ cross_board_out
		-- Your task.

	consistent_plus_board_outputs: plus_board.out ~ plus_board_out
		-- Your task.

	consistent_pyramid_board_outputs: pyramid_board.out ~ pyramid_board_out
		-- Your task.

	consistent_arrow_board_outputs: arrow_board.out ~ arrow_board_out
		-- Your task.

	consistent_diamond_board_outputs: diamond_board.out ~ diamond_board_out
		-- Your task.

	consistent_skull_board_outputs: skull_board.out ~ skull_board_out
		-- Your task.
end
